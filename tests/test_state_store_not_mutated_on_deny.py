...
def test_state_store_not_mutated_on_deny() -> None:
    payload = {
        "object_id": "inv-001",
    ...
    before = state_store.objects["inv-001"].copy()
    ...
    after = state_store.objects["inv-001"].copy()
    ...
    assert audit_log.events[-1]["reason"] == "inadmissible_transition"
